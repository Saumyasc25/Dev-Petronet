...
const ReviewMocRequest: React.FC<MocRequestCreationProps> = ({ onCancel }) => {
  ...
  setCurrentStep(2);
  navigate(
    `/station-operations/Moc/NextFinalReview/${encodeURIComponent(moc_request_no)}`,
    { state: { step: 2 } }
  );
};
...
export default ReviewMocRequest;