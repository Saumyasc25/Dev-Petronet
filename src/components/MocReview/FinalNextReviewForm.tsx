...
import FinalNextReviewFormModel from "./FinalNextReviewFormModel";

interface NextRequestFormProps {
  onCancel?: () => void;
}

const FinalNextReviewForm: React.FC<NextRequestFormProps> = ({ onCancel }) => {
...
export default FinalNextReviewForm;