...
import HiraNextReviewFormModel from "./HiraNextReviewFormModel";

interface NextRequestFormProps {
  onCancel?: () => void;
}

const HiraNextReviewForm: React.FC<NextRequestFormProps> = ({ onCancel }) => {
...
export default HiraNextReviewForm;