...
const EdgeDeviceSelectField: React.FunctionComponent<ISelectFieldProps> = ({
  variable,
  displayLabel = true,
}) => {
      ...
      if (variable.API) {
        ...
        const staticOptions = variable.options.map((option: any) => {
          if (typeof option === "string" || typeof option === "number") {
            return { id: option, name: String(option) }
          }
          if (option.label !== undefined && option.value !== undefined) {
            return { id: option.value, name: String(option.label) }
          }
          return { id: JSON.stringify(option), name: String(option) }
        })
        setDropOptions(staticOptions)
        setFilteredOptions(staticOptions)
      } else {
...
export default EdgeDeviceSelectField
